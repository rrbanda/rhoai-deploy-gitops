...
AUTORAG_DIR="${REPO_ROOT}/rhoai/base/03-workloads/autorag"
CLUSTER_DIR="${REPO_ROOT}/rhoai/base/02-config"
...
echo "Next steps:"
echo "  1. git add rhoai/base/*/sealed-*.yaml rhoai/base/**/sealed-*.yaml"
